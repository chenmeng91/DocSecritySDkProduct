...
import docsecuritysdk.eetrust.com.docsecuritysdk.R;
...
//		}
		...
		case R.id.btnSetInkThick:
			setInkThick();
			break;
		case R.id.btnGetForbittenInk:
			getForbittenInk();
			break;
		case R.id.btnGetShowRevisions:
			getShowRevisions();
			break;
		case R.id.btnDeletShape:
			deleteShape();
			break;
		case R.id.btnGetDocProp:
			getDocProp();
			break;
		case R.id.btnGetPage:
			getPage();
			break;
		case R.id.btnSetPageOrientation:
			setPageOrientation();
			break;
		case R.id.btnSetPageWidth:
			setPageWidth();
			break;
		case R.id.btnSetPageHeight:
			setPageHeigth();
			break;
		case R.id.btnSetPageLeft:
			setPageLeft();
			break;
		case R.id.btnSetPageRight:
			setPageRight();
			break;
		case R.id.btnSetPageTop:
			setPageTop();
			break;
		case R.id.btnSetPageBottom:
			setPageBottom();
			break;
		...
		case R.id.btnAddBookmark:
			addBookmark();
			break;
		case R.id.btnDeleteBookmark:
			deleteBookmark();
			break;
//		houjing补充
		case R.id.btngetBookmarkText:
			getBookmarkText();
			break;
		case R.id.btnsetBookmarkText:
			setBookmarkText();
			break;
		case R.id.btngetPageOrientation:
			getPageOrientation();
			break;
		case R.id.btngetPageWidth:
			getPageWidth();
			break;
		case R.id.btngetPageHeight:
			getPageHeight();
			break;
		case R.id.btngetLeftMargin:
			getLeftMargin();
			break;
		case R.id.btngetRightMargin:
			getRightMargin();
			break;
		case R.id.btngetTopMargin:
			getTopMargin();
			break;
		case R.id.btngetBottomMargin:
			getBottomMargin();
			break;
		case R.id.btngetActiveDocument:
			getActiveDocument();
			break;
		case R.id.btngetSelection:
			getSelection();
			break;
		case R.id.btnrangecopy:
			rangecopy();
			break;
		case R.id.btnrangepaste:
			rangepaste();
			break;
		case R.id.btnrangecollapse:
			rangecollapse();
			break;
		case R.id.btngetUnderline:
			getUnderline();
			break;
		case R.id.btnsetUnderline:
			setUnderline();
			break;	
		case R.id.btnsetStyle:
			setStyle();
			break;
		case R.id.btngetStyle:
			getStyle();
			break;
		case R.id.btnsetItalic:
			setItalic();
			break;
		case R.id.btnisItalic:
			isItalic();
			break;
		case R.id.btnsetBold:
			setBold();
			break;
		case R.id.btnisBold:
			isBold();
			break;
		case R.id.btnrangegetFont:
			rangegetFont();
			break;
		case R.id.btnrangesetEnd:
			rangesetEnd();
			break;
		case R.id.btnrangegetEnd:
			rangegetEnd();
			break;
		case R.id.btnrangesetStart:
			rangesetStart();
			break;
		case R.id.btnrangegetStart:
			rangegetStart();
			break;
		case R.id.btnrangesetText:
			rangesetText();
			break;
		case R.id.btnrangegetText:
			rangegetText();
			break;
		case R.id.btnrangedelete:
			rangedelete();
			break;
		case R.id.btnrangeexpand:
			rangeexpand();
			break;
		case R.id.font_setBold:
			font_setBold();
			break;
		case R.id.font_setItalic:
			font_setItalic();
			break;
		case R.id.font_setTextColor:
			font_setTextColor();
			break;
		case R.id.font_part_setName:
			font_part_setName();
			break;
		case R.id.font_setStrikeThrough:
			font_setStrikeThrough();
			break;
		case R.id.font_setDoubleStrikeThrough:
			font_setDoubleStrikeThrough();
			break;
//		case R.id.font_part_setNoneStrikeThrough:
//			font_setNoneStrikeThrough();
//			break;
		case R.id.font_getSuperscript:
			font_getSuperscript();
			break;
		case R.id.font_setSuperscript:
			font_setSuperscript();
			break;
		case R.id.font_getSubscript:
			font_getSubscript();
			break;
		case R.id.font_setSubscript:
			font_setSubscript();
			break;
		case R.id.font_getBoldBi:
			font_getBoldBi();
			break;
		case R.id.font_setBoldBi:
			font_setBoldBi();
			break;
		case R.id.font_getSmallCaps:
			font_getSmallCaps();
			break;
		case R.id.font_setSmallCaps:
			font_setSmallCaps();
			break;
		case R.id.font_getAllCaps:
			font_getAllCaps();
			break;
		case R.id.font_setAllCaps:
			font_setAllCaps();
			break;
//		case R.id.font_setNoneStrikeThrough:
//			font_setNoneStrikeThrough();
//			break;
		case R.id.font_getDoubleStrikeThrough2:
			font_getDoubleStrikeThrough2();
			break;
		case R.id.font_setDoubleStrikeThrough2:
			font_setDoubleStrikeThrough2();
			break;
		case R.id.font_setStrikeThrough2:
			font_setStrikeThrough2();
			break;
		case R.id.font_shrink:
			font_shrink();
			break;
		case R.id.font_grow:
			font_grow();
			break;
		case R.id.font_getSize:
			font_getSize();
			break;
		case R.id.font2_setSize:
			font_setSize();
			break;
		case R.id.font_getNameFarEast:
			font_getNameFarEast();
			break;
		case R.id.font_setNameFarEast:
			font_setNameFarEast();
			break;
		case R.id.font_getNameAscii:
			font_getNameAscii();
			break;
		case R.id.font_setName:
			font_setName();
			break;
		case R.id.font_getTextColor:
			font_getTextColor();
			break;
//		case R.id.font2_setTextColor:
//			font2_setTextColor();
//			break;
		case R.id.font_getUnderlineColor:
			font_getUnderlineColor();
			break;
		case R.id.font_setUnderlineColor:
			font_setUnderlineColor();
			break;
		case R.id.font_getUnderline2:
			font_getUnderline2();
			break;
		case R.id.font_setUnderline2:
			font_setUnderline2();
			break;
		case R.id.font_getItalic2:
			font_getItalic2();
			break;
		case R.id.font_setItalic2:
			font_setItalic2();
			break;
		case R.id.font_setBold2:
			font_setBold2();
			break;
		case R.id.font_getItalic:
			font_getItalic();
			break;
		case R.id.SelectionaddComment:
			SelectionaddComment();
			break;
		case R.id.SelectiongetShapeRange:
			SelectiongetShapeRange();
			break;
		case R.id.SelectiongetInformation:
			SelectiongetInformation();
			break;
		case R.id.SelectiongetRightOnScreen:
			SelectiongetRightOnScreen();
			break;
		case R.id.SelectiongetBottomOnScreen:
			SelectiongetBottomOnScreen();
			break;
		case R.id.InlineShapesgetWidth:
			InlineShapesgetWidth();
			break;
		case R.id.InlineShapesgetHeight:
			InlineShapesgetHeight();
			break;
		case R.id.InlineShapessetScaleWidth:
			InlineShapessetScaleWidth();
			break;
		case R.id.InlineShapessetScaleHeight:
			InlineShapessetScaleHeight();
			break;
		case R.id.InlineShapessetHeight:
			InlineShapessetHeight();
			break;
		case R.id.InlineShapessetWidth:
			InlineShapessetWidth();
			break;
		case R.id.InlineShapesgetScaleWidth:
			InlineShapesgetScaleWidth();
			break;
		case R.id.InlineShapesgetScaleHeight:
			InlineShapesgetScaleHeight();
			break;
		case R.id.InlineShapesgetOLE:
			InlineShapesgetOLE();
			break;
		case R.id.InlineShapesgetCount:
			InlineShapesgetCount();
			break;
//		case R.id.InlineShapessetAlternativeText:
//			InlineShapessetAlternativeText();
//			break;
		case R.id.InlineShapesgetAlternativeText:
			InlineShapesgetAlternativeText();
			break;
		case R.id.InlineShapesaddOLEControl:
			InlineShapesaddOLEControl();
			break;
			//document
		case R.id.document_getName:
			document_getName();
			break;		
		case R.id.document_getPage:
			document_getPage();
			break;		
		case R.id.document_getPageCount:
			document_getPageCount();
			break;		
		case R.id.document_getSelection:
		...
		case R.id.document_save:
			document_save();
			break;		
		case R.id.document_acceptAllRevisions:
			document_acceptAllRevisions();
			break;		
		case R.id.document_acceptAllRevise:
			document_acceptAllRevise();
			break;		
		case R.id.document_pageUp:
			document_pageUp();
			break;		
		case R.id.document_pageDown:
			document_pageDown();
			break;		
		case R.id.document_getCommentNumber:
			document_getCommentNumber();
			break;		
		case R.id.document_isInRevisionMode:
			document_isInRevisionMode();
			break;		
		case R.id.document_getUser:
			document_getUser();
			break;		
		case R.id.document_isInHandWriterMode:
			document_isInHandWriterMode();
			break;		
		case R.id.document_getBuiltInDocumentProperties:
			document_getBuiltInDocumentProperties();
			break;		
		case R.id.document_saveToImage:
			document_saveToImage();
			break;		
		case R.id.document_changeRevisionState:
			document_changeRevisionState();
			break;		
		case R.id.document_close2:
			document_close2();
			break;		
		case R.id.document_delAllComments:
			document_delAllComments();
			break;		
		case R.id.document_denyAllRevision:
			document_denyAllRevision();
			break;		
		case R.id.document_getProtectionType2:
			document_getProtectionType2();
			break;		
		case R.id.document_setSaved:
			document_setSaved();
			break;		
		case R.id.document_getViewProgress:
			document_getViewProgress();
			break;		
		case R.id.document_getViewScale:
			document_getViewScale();
			break;		
		case R.id.document_getViewScrollX:
			document_getViewScrollX();
			break;		
		case R.id.document_getViewScrollY:
			document_getViewScrollY();
			break;		
		case R.id.document_isLoadOK:
			document_isLoadOK();
			break;		
		case R.id.document_protect2:
			document_protect2();
			break;		
		case R.id.document_range:
			document_range();
			break;		
		case R.id.document_redo2:
			document_redo2();
			break;		
		case R.id.document_rejectAllRevisions:
			document_rejectAllRevisions();
			break;		
		case R.id.document2_save:
			save();
			break;		
		case R.id.document_setUser:
			document_setUser();
			break;		
		case R.id.document_undo2:
			document_undo2();
			break;		
		case R.id.document_undoClear:
			document_undoClear();
			break;		
		case R.id.document_unProtectDocument:
			document_unProtectDocument();
			break;		
		case R.id.document_getContent:
			document_getContent();
			break;		
//Shapes
		case R.id.Shapes_addPicture:
			Shapes_addPicture();
			break;		
		case R.id.Shapes_addPicture2:
			Shapes_addPicture2();
			break;		
		case R.id.Shapes_addTextbox2:
			Shapes_addTextbox2();
			break;		
		case R.id.Shapes_addOLEControl:
			Shapes_addOLEControl();
			break;		
		case R.id.Shapes_addShape:
			Shapes_addShape();
			break;		
			
//shape
		case R.id.shape_getIPictureFormat:
			shape_getIPictureFormat();
			break;		
		case R.id.shape_getOLE:
			shape_getOLE();
			break;		
		case R.id.shape_select:
			shape_select();
			break;		
		case R.id.shape_getWrapFormat:
			shape_getWrapFormat();
			break;		
		case R.id.shape_hasInk:
			shape_hasInk();
			break;		
		case R.id.shape_incrementTop:
			shape_incrementTop();
			break;		
		case R.id.shape_incrementLeft:
			shape_incrementLeft();
			break;		
		case R.id.shape_getWidth:
			shape_getWidth();
			break;		
		case R.id.shape_setVisible:
			shape_setVisible();
			break;		
		case R.id.shape_getVisible:
			shape_getVisible();
			break;		
		case R.id.shape_getType:
			shape_getType();
			break;		
		case R.id.shape_getTop:
			shape_getTop();
			break;		
		case R.id.shape_getTextFrame:
			shape_getTextFrame();
			break;		
		case R.id.shape_getLine:
			shape_getLine();
			break;		
		case R.id.shape_getLeft:
			shape_getLeft();
			break;		
		case R.id.shape_getHeight:
			shape_getHeight();
			break;		
		case R.id.shape_getGroupItems:
			shape_getGroupItems();
			break;		
		case R.id.shape_getFill:
			shape_getFill();
			break;		
		case R.id.shape_getAlternativeText:
			shape_getAlternativeText();
			break;		
		case R.id.shape_setAlternativeText:
			shape_setAlternativeText();
			break;		

//View	
		case R.id.View_putRevisionsView:
			View_putRevisionsView();
			break;	
		case R.id.View_putShowRevisionsAndComments:
			View_putShowRevisionsAndComments();
			break;	
		case R.id.View_getShowRevisionsAndComments:
			View_getShowRevisionsAndComments();
			break;	
		case R.id.View_getRevisionsView:
			View_getRevisionsView();
			break;	
			
//						Other
		case R.id.setVisibleFill:
			setVisibleFill();
			break;	
		case R.id.setVisibleLine:
			setVisibleLine();
			break;	
		case R.id.getGroupItemsItem:
			getGroupItemsItem();
			break;	
		case R.id.getGroup:
			getGroup();
			break;	
		case R.id.getTextRange:
			getTextRange();
			break;	
		case R.id.groupCount:
			groupCount();
			break;	
		case R.id.getOpenDocument:
			getOpenDocument();
			break;
		case R.id.getRevision:
			getRevision();
			break;
		case R.id.btnReadMode:
			changeReadMode();
			break;
//		以上houjing补充
		default:
...
//		try 
//		{
//			float left = mDoc.getSelection().getRightScreenPos();   
...
//		try 
//		{
//			float top = mDoc.getSelection().getBottomScreenPos();
...
//					bundle.putBoolean("DisplayView", false); 
				mService.setSecurityKey("abcdef0123456789".getBytes());
...
//					{
//						mDoc.getShapes().item(j).deleteRightAndkeyTable();
//					}
//				}
//			}
			for (int j = 1; j <= mDoc.getShapes().getCount(); j++)
...
//			{
//				mDoc.getShapes().item(1).deleteRightAndkeyTable();
...
//	获取书签值
	private void getBookmarkText()
	{
		...
		try 
		{
			...
			{
				String message = "第一个书签值为： " + mDoc.getBookmarks().item(1).range().getText();
			    Util.showToast(mContext, message);
			}			
		} 
		catch (RemoteException e)
...
//			if(!mDoc.range(0, 10).isItalic())
				try 
				{
					mDoc.range(0, 10).setItalic(true);
				}
				catch (RemoteException e)
				{
					Util.showToast(mContext, FAIL_NOTE);
...
//			}
	...
	private void font_getAllCaps()
	{
		...
		try 
		{
			Util.showToast(mContext,  "当前文本全部小写：" + mDoc.getSelection().getFont().getAllCaps());
		}
		catch (RemoteException e)
		{
			Util.showToast(mContext, FAIL_NOTE);
...
//	重复	
	private void document_getPage()
	{
		...
		try 
		{	
			Util.showToast(mContext,  "文档第2页高度：" + mDoc.getPage(2));
		}
		catch (RemoteException e)
		{
			Util.showToast(mContext, FAIL_NOTE);
...
//		{	
//			Variant arg0 = null;
//			Util.showToast(mContext, "获得OLE对象：" + mDoc.getShapes().item(1).selectRightAndkeyTable(arg0));
//		} 
//		catch (RemoteException e) 
//		{
//			Util.showToast(mContext, FAIL_NOTE);
...
//		}
	...
	private void View_putShowRevisionsAndComments()
	{
		...
		try 
		{	
			mDoc.getActiveWindow().getView().putShowRevisionsAndComments(true);
