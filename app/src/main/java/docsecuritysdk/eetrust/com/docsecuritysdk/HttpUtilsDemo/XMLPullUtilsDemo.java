...
public class XMLPullUtilsDemo {
    ...
    public static class XMLUtilsHolder {
        ...
        public static XMLPullUtilsDemo instance = new XMLPullUtilsDemo();
    }

    private XMLPullUtilsDemo() {
        parser = Xml.newPullParser();
    }

    public static XMLPullUtilsDemo getInstance() {
    ...
    private Map<String, Object> norMalResult(String result) {
        ...
        try {
            ...
            map.clear();
            map.put(HttpFieldsDemo.NET_RESULT, HttpFieldsDemo.NET_REQUEST_FAIL);
            map.put(HttpFieldsDemo.NET_ERROR, HttpFieldsDemo.NET_ABNORMAL);
            return map;
        } catch (IOException e) {
            map.clear();
            map.put(HttpFieldsDemo.NET_RESULT, HttpFieldsDemo.NET_REQUEST_FAIL);
            map.put(HttpFieldsDemo.NET_ERROR, e.toString());
            return map;
        }
    }
    ...
    public Map<String, Object> issueDoc(String result) {
        ...
        try {
            ...
            resultMap.clear();
            resultMap.put(HttpFieldsDemo.NET_RESULT, HttpFieldsDemo.NET_REQUEST_FAIL);
            resultMap.put(HttpFieldsDemo.NET_ERROR, HttpFieldsDemo.NET_ABNORMAL);
            return resultMap;
        } catch (IOException e) {
            resultMap.clear();
            resultMap.put(HttpFieldsDemo.NET_RESULT, HttpFieldsDemo.NET_REQUEST_FAIL);
            resultMap.put(HttpFieldsDemo.NET_ERROR, e.toString());
            return resultMap;
        }
    }
